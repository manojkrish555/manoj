...
import com.kg.emailclientcrud.model.User;

@WebServlet("/UserController")
public class UserController extends HttpServlet {

     ArrayList<User> userList = new ArrayList<User>();
    // public List<User> userList = Arrays.asList(new User(1, "email", "password"), new User(2, "email2", "password2"),
    ...
    private void listUser(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        userList.add(new User(1, "Apple","1234"));
        userList.add(new User(2, "Orange","1234"));
        userList.add(new User(3, "Mango","1234"));
